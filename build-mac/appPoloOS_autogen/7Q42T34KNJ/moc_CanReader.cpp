...
void CanReader::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->busConnected(); break;
        case 1: _t->busDisconnected(); break;
        case 2: _t->busError((*reinterpret_cast<std::add_pointer_t<QString>>(_a[1]))); break;
        case 3: _t->processReceivedFrames(); break;
        case 4: _t->checkBusHealth(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (CanReader::*)()>(_a, &CanReader::busConnected, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (CanReader::*)()>(_a, &CanReader::busDisconnected, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (CanReader::*)(const QString & )>(_a, &CanReader::busError, 2))
            return;
    }
}
...
// SIGNAL 0
void CanReader::busConnected()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void CanReader::busDisconnected()
{
    QMetaObject::activate(this, &staticMetaObject, 1, nullptr);
}

// SIGNAL 2
void CanReader::busError(const QString & _t1)
{
